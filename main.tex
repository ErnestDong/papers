...
\begin{table}[H]
    \small\input{results/table1.tex}
...
\begin{table}[H]
    \centering
    \input{results/ks_test.tex}
    \caption{两个独立样本的K-S检验}\label{tab:KS}
\end{table}
\begin{table}[H]
    \centering
    \input{results/mw_test.tex}
...
\begin{table}[H]
    \centering
    \input{results/pearsons.tex}
    \caption{违约距离与总资产的相关系数}\label{tab:asset}
\end{table}
\begin{table}[H]
    \centering
    \input{results/pearsons_vol.tex}
